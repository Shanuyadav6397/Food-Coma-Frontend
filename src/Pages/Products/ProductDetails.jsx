...
import { getProductDetails } from "../../Redux/Slices/ProductSlice.js";
import Layout from "../../Layouts/Layout.jsx";
import { addProductToCart, getCartDetails, removeProductFromCart } from "../../Redux/Slices/CartSlice.js";

function ProductDetails() {
    const { productId } = useParams();
    const dispatch = useDispatch();
    const [productDetails, setProductDetails] = useState({});
    const [isInCart, setIsInCart] = useState(false); // to check if the product is in the cart


    async function fetchProductDetails() {
        const details = await dispatch(getProductDetails(productId));
        // console.log("Product details", details?.payload?.data);
    ...
    async function handleCart() {
        ...
        if (response?.payload?.success) {
            setIsInCart(true);
            dispatch(getCartDetails()); // fetch the cart details and update the cart data(state)
        }
    }
